...
app.use('/magic_cards/:id', require('./controllers/cards'));
app.use('/chess_pieces/:id', require('./controllers/chess'));
app.use('/food/:id', require('./controllers/food'));
app.use('/dogs/:id', require('./controllers/dogs'));
